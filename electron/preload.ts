...
const api: IpcApi = {
  ...
  reportes: {
    resumen: (filtro) => ipcRenderer.invoke("reportes:resumen", filtro),
    finanzas: (filtro) => ipcRenderer.invoke("reportes:finanzas", filtro),
    carteraDetalle: () => ipcRenderer.invoke("reportes:carteraDetalle"),
    serviciosDetalle: (filtro) => ipcRenderer.invoke("reportes:serviciosDetalle", filtro),
    clientesDetalle: (filtro) => ipcRenderer.invoke("reportes:clientesDetalle", filtro),
    agenda: (filtro) => ipcRenderer.invoke("reportes:agenda", filtro),
